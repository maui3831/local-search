...
def simulated_annealing(puzzle, initial_temperature=1.0, cooling_rate=0.995, min_temperature=0.01, max_iterations=10000):
    ...
    while temperature > min_temperature and iteration < max_iterations and not current_puzzle.is_goal():
...
def main():
    ...
    if best_puzzle.is_goal():
        print(f"Solution found in {iterations} iterations and {end_time - start_time:.2f} seconds!")
